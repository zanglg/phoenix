...
- `docs/USER_COPY.md`: checked bidirectional physical-frame user copies and bounded I/O contract.
- `docs/FILE_DESCRIPTORS.md`: read-only initramfs file table and transactional offset contract.
